...
export const {useSaveBlogPostMutation, useGetAllBlogsQuery, useGetOneBlogQuery, useLikeControlMutation, useSaveCommentMutation, useGetCommentatorProfileQuery} = feedApi; 